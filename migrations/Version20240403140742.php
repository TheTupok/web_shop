 ...
 */
final class Version20240403140742 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD CONSTRAINT FK_D34A04ADFAE957CD FOREIGN KEY (preview_image_id) REFERENCES file (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
